...
struct db_query db_sqlite3_queries[] = {
    ...
    },
    {
         ...
         .query = "INSERT INTO outputs (  prev_out_tx, prev_out_index, value, type, status, keyindex, channel_id, peer_id, commitment_point, confirmation_height, spend_height, scriptpubkey) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);",
         .placeholders = 12,
         .readonly = false,
    },
    {
    ...
    },
    {
         ...
         .query = "SELECT  prev_out_tx, prev_out_index, value, type, status, keyindex, channel_id, peer_id, commitment_point, confirmation_height, spend_height, scriptpubkey FROM outputs WHERE status= ? ",
         .placeholders = 1,
         .readonly = true,
    },
    {
    ...
    },
    {
         ...
         .query = "UPDATE channel_htlcs SET hstate=?, payment_key=?, malformed_onion=?, failuremsg=? WHERE id=?",
         .placeholders = 5,
         .readonly = false,
    },
    {
         ...
         .query = "SELECT  id, channel_htlc_id, msatoshi, cltv_expiry, hstate, payment_hash, payment_key, routing_onion, failuremsg, malformed_onion, origin_htlc, shared_secret, received_time FROM channel_htlcs WHERE direction= ? AND channel_id= ? AND hstate != ?",
         .placeholders = 3,
         .readonly = true,
    },
    {
         ...
         .query = "SELECT  id, channel_htlc_id, msatoshi, cltv_expiry, hstate, payment_hash, payment_key, routing_onion, failuremsg, malformed_onion, origin_htlc, shared_secret, received_time, partid FROM channel_htlcs WHERE direction = ? AND channel_id = ? AND hstate != ?",
         .placeholders = 3,
         .readonly = true,
    },
    {
...
#define DB_SQLITE3_QUERY_COUNT 249
