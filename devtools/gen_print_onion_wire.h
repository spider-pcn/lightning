...
#ifndef LIGHTNING_DEVTOOLS_GEN_PRINT_ONION_WIRE_H
#define LIGHTNING_DEVTOOLS_GEN_PRINT_ONION_WIRE_H
#include <ccan/tal/tal.h>
#include <devtools/print_wire.h>
#include <wire/onion_defs.h>

void printonion_type_message(const u8 *msg);

void printonion_type_tlv_message(const char *tlv_name, const u8 *msg);
...
#endif /* LIGHTNING_DEVTOOLS_GEN_PRINT_ONION_WIRE_H */
