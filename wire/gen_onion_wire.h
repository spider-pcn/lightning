...
#ifndef LIGHTNING_WIRE_GEN_ONION_WIRE_H
#define LIGHTNING_WIRE_GEN_ONION_WIRE_H
...
struct tlv_tlv_payload_amt_to_forward {
        u64 amt_to_forward;
};
struct tlv_tlv_payload_outgoing_cltv_value {
        u32 outgoing_cltv_value;
};
struct tlv_tlv_payload_short_channel_id {
...
struct tlv_tlv_payload {
	 ...
	 * tlv_field entries above to save on memory. */
        struct tlv_tlv_payload_amt_to_forward *amt_to_forward;
        struct tlv_tlv_payload_outgoing_cltv_value *outgoing_cltv_value;
        struct tlv_tlv_payload_short_channel_id *short_channel_id;
...
#endif /* LIGHTNING_WIRE_GEN_ONION_WIRE_H */
